...
public class Transacoes {
    ...
    public void realizarTransacao(String tipoConta, String cpf, double valor, boolean isDeposito) {
    ...
    private void registrarExtrato(String tipoConta, String cpf, double valor, boolean isDeposito, double saldoFinal) {
    ...
    // Método para saque
    public void sacar(String tipoConta, String cpf, double valor) {
        realizarTransacao(tipoConta, cpf, valor, false);
    }

    // Método para depósito
    public void depositar(String tipoConta, String cpf, double valor) {
